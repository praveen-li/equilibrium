...
This information can be found from the threads running under rsyslogd.
```
admin@host $ ps -p 201562
    PID TTY          TIME CMD
     201562 ?        00:02:57 rsyslogd
     admin@host $ ps -T -p 201562
